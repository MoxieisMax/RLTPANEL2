...
export const PRODUCTS: Record<string, Product> = {
  'hooga-hg300': {
    ...
    amazonUrl: 'https://www.amazon.com/dp/B07TDP67LR?tag=your-tag-20',
  ...
  'bestqool-pro300': {
    ...
    amazonUrl: 'https://www.amazon.com/dp/B08G8S9Z9X?tag=your-tag-20',
  ...
  'platinumled-biomax300': {
    ...
    ledCount: 60,
    size: '17.7" x 6" x 3"',
    amazonUrl: 'https://www.amazon.com/dp/B0867QRZFN?tag=your-tag-20',
  ...
  'dgyao-60led': {
    ...
    amazonUrl: 'https://www.amazon.com/dp/B09NM5KGMJ?tag=your-tag-20',
  ...
  'mitored-mitopro-300': {
    ...
    name: 'Mito Red Light MitoPRO 300',
    ...
    ledCount: 60,
    size: '11.5" x 8.5" x 3"',
    amazonUrl: 'https://www.amazon.com/dp/B08LW3Z8L9?tag=your-tag-20',
    imageUrl: 'https://m.media-amazon.com/images/P/B08LW3Z8L9.01._SCLZZZZZZZ_.jpg',
    rating: 4.8,
    reviews: 987,
    bestFor: 'Professional Efficiency',
    pros: ['4-wavelength spectrum targets skin and deep tissue', 'Modular — snap multiple units together', 'Very low EMF output', 'Backed by clinical research'],
    cons: ['Higher price point', 'Best used with a stand or mounting bracket']
  },
  'hooga-hg1500': {
    id: 'hooga-hg1500',
    name: 'Hooga HG1500 Full Body Red Light Panel',
    brand: 'Hooga',
    price: 499.00,
    wavelengths: ['660nm', '850nm'],
    irradiance: '>100 mW/cm² at 6"',
    ledCount: 150,
    size: '36" x 8.3" x 2.7"',
    amazonUrl: 'https://www.amazon.com/dp/B09MBH9PXG?tag=your-tag-20',
    imageUrl: 'https://m.media-amazon.com/images/P/B09MBH9PXG.01._SCLZZZZZZZ_.jpg',
    rating: 4.6,
    reviews: 643,
    bestFor: 'Best Full-Body Coverage',
    pros: ['150 LEDs cover full torso in one session', 'Dual cooling fan system', 'Stackable with other Hooga panels', 'CE & RoHS certified'],
    cons: ['Large footprint requires dedicated space', 'No timer — use an external outlet timer']
  }
};
